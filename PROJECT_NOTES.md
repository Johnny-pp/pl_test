...
- 当前存档版本为 v10，旧存档会迁移并清理非法等级、负经验、负生命值和无效区域标识，同时补齐任务、首领、世界探索、个体构筑、阶段十七（货币、掉落物、支线、NPC、机关、精英、商店库存）与阶段十八（基地布局、科技、订单、矿石/金属）进度；个体构筑（技能树、装备技能、装备槽）在迁移时安全补齐。
...
- 当前存档版本为 v10，旧个体迁移时补齐技能树节点、装备技能与空装备槽；装备与个体构筑字段均持久化并可随导入导出迁移。
